        ...
        <div class="mx-auto max-w-xl">
            ...
            <form action="{{ route('pegawai.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="nama" name="nama" value="{{ old('nama') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center">
                            <input id="male" type="radio" value="male" name="gender" {{ old('gender') == 'male' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500" required>
                            <label for="male" class="ms-2 text-sm font-medium text-gray-900">Laki-laki</label>
                        </div>
                        <div class="flex items-center">
                            <input id="female" type="radio" value="female" name="gender" {{ old('gender') == 'female' ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <div class="flex gap-4 items-center mb-2">
                        <span class="captcha-img">{!! app('captcha')->img('flat') !!}</span>
                        <button type="button" class="text-white bg-gray-500 hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-xs px-3 py-1.5" onclick="reloadCaptcha()">Reload Captcha</button>
                    </div>
                    <input type="text" name="captcha" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan karakter yang muncul pada gambar" required>
                </div>
